<?php
	...
	$busqueda=mysqli_query($sentencia);
?>
<table align="center"><tr>
<td>
<form name="form2" action="reservas.php" method="POST">
<h4>-PELICULA: </h4></td></tr>
<tr><td><select name="id_proy"><option>AAA</option><option>2</option><?while($row = mysqli_fetch_row($busqueda)){echo "<option value='".$row[0]."'>".$row[1]."</option>";}?></select></td></tr>
